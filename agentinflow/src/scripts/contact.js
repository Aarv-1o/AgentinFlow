// Contact form.
//
// Lifted from the original home-page script when the form moved to the
// Services page. The reviews renderer and the scroll-to-section helper were
// left behind - neither has anything to do with sending an enquiry.
...
// Note: the footer still lists 9584598779 for WhatsApp. These need
// reconciling - one of the two numbers is wrong.
const WHATSAPP_NUMBER = '919343393388';
